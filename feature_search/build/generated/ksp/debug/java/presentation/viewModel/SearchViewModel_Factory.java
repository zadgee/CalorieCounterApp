...
public final class SearchViewModel_Factory implements Factory<SearchViewModel> {
  ...
  public SearchViewModel_Factory(Provider<SearchNavigationRouter> navigationRouterProvider,
  ...
  public static SearchViewModel_Factory create(
      ...
      Provider<SearchRepository> repositoryProvider) {
    return new SearchViewModel_Factory(navigationRouterProvider, repositoryProvider);
  }

  public static SearchViewModel newInstance(SearchNavigationRouter navigationRouter,
      SearchRepository repository) {
    return new SearchViewModel(navigationRouter, repository);
  }
}
