...
public final class AuthenticationViewModelFactory_Factory implements Factory<AuthenticationViewModelFactory> {
  ...
  public AuthenticationViewModelFactory_Factory(
  ...
  public static AuthenticationViewModelFactory newInstance(
    ...
    return new AuthenticationViewModelFactory(addUserToFireStoreUseCase, deleteUserFromFirebaseUseCase, loginUseCase, reloadUserUseCase, sendEmailVerificationLetterUseCase, signOutWhileUsingEmailPasswordUseCase, signOutWhileUsingGmailAuth, signUpUseCase, oneTapClient, getFirebaseUserUseCase, insertUserUseCase, getUserNameFromFireStoreByEmail, signIn, signUp, gmailAuthUseCase, insertGmailUserUseCase, sendPasswordResetEmailUseCase, workManager, getFirebaseUserDataUseCase, isUserExistUseCase);
  }
}
